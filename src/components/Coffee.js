    ...
    render(){
        return (
            <section id={'content-area'}>
              <div className="col-md-6 coffee_one">
                <img className="coffee_img" src="http://www.earlyadopter.co.kr/wp-content/uploads/2016/10/supreme-brick-1.jpg"
                  heigt="300px" width="400px"
                  />
                <div className="col-md-6 coffee_info">
                  <h5>Supreme</h5><br/>
